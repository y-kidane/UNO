...
//testing for first_card() function:

// let start_pile: GamePile = empty_s<Card>();
// const test_deck: Deck = empty_q<Card>();
// make_wild_card(test_deck);
// enqueue(make_card("red", 8), test_deck);
// enqueue(make_card("blue", "+2"), test_deck);
// enqueue(make_card("yellow", 1), test_deck);
// enqueue(make_card("red", 0), test_deck);

// shuffle(test_deck);
// const after_t: GamePile = start_card(start_pile, test_deck);

// if(is_empty_s(after_t)){
//     console.log("error, no cards in here");
// } else{
//     console.log("this is the start card: ", top(after_t));
//     for_each(x => console.log(x), after_t);
// }